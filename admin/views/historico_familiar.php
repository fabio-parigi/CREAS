					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>7. Histórico familiar</h4> 
			                    <div class="tools">
							...
							<div class="form-group">
							  <label for="textinput">Formação inicial da família</label>  
							  <input id="textinput" name="textinput" placeholder="(relacionamento, figura de autoridade, religião,
problema de dependência química, outras questões referentes à saúde física e mental" class="form-control input-md" type="text">
							</div>
		

							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Situação Atual</label>  

<?php
     ...
     **********************************************/
			...
			if(isset ($_REQUEST['nome']) && isset ($_REQUEST['descricao']) && isset ($_REQUEST['enviar']) ){
				...
				$Editada = new CargoSchema($_REQUEST['idEdit'],$_REQUEST['nome'],$_REQUEST['descricao']);

				if($ControladorCargo->EditarCargo($Editada,$Banco)){

					$tipo = "sucesso";
					$msgn = "Cargo editado com sucesso.";
					$confirma = TRUE;
			...
			//$filtro = "WHERE id_cargo = ".$_REQUEST['idEdit'].";";	// busca no banco qual o registro com o ID recebido via parametro
			$result = $ControladorCargo->BuscarCargo($Banco, $_REQUEST['idEdit']); // busca um único valor
						...
						<div class="portlet box grey">
		                    ...
		                    <div class="portlet-body form">
		                        <form name="formUsuario" class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"/>
									...
									<input type="hidden" name="idEdit" value="<?php echo $linha['id_cargo']; ?>" >
											 
			                        <div class="control-group">
			                           	<label class="control-label">Nome do Cargo</label>
			                           	<div class="controls">
			                               	<input class="span6 m-wrap" name="nome" value="<?php echo $linha['nome_cargo']; ?>" type="text" pattern=".{0,100}" REQUIRED>
			                           	</div>
			                        </div> 			
			                        ...
			                        <div class="control-group">
			                           	...
			                           	<div class="controls">
			                               	<input class="span12 m-wrap" name="descricao" value="<?php echo $linha['descricao_cargo']; ?>"  type="text" pattern=".{0,100}" REQUIRED>
			                           	</div>
			                        </div> 

					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>11. Atividades Laborativas</h4> 
			                    <div class="tools">
							...
							<!-- Form Name -->
							<legend> Atividades Laborativas</legend>

		
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Ocupação Atual</label>  
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Local de trabalho</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Horário</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Salário</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Áreas de interesse</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

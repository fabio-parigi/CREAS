<?php
     ...
     **********************************************/
		if(isset($_REQUEST['idDelete'])) {
		    if($ControladorInstituicoes->DeletarInstituicao($_REQUEST['idDelete'], $Banco)){
				$tipo = "sucesso";
		    	...
		    	$tipo = "erro";
		    	$msgn = "Ocorreu um erro ao deletar a Instituição. Informe ao Administrador que ocorreu um \"Exception\" no Banco de Dados para que ele possa arrumar.";
		    	$confirma = TRUE;
		    }
	    }


	    $result = $ControladorInstituicoes->ListarInstituicoes($Banco, "");
...
<body class="fixed-top">
	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<?php $Paginas->setTitleBarra("Instituições","Instituições<span class=\"icon-angle-right\"></span>Geral"); ?>
					</div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<!-- DELETE FORM -->
							<form name="formDelete" type="hidden"  action="instituicoes.php" method="post"/>
								<input type="hidden" name="idDelete" value="">
							</form>
						<!-- END DELETE FORM -->

						<!-- EDIT FORM -->
							<form name="formEdit" type="hidden"  action="editar_instituicao.php" method="post"/>
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-reorder"></i>Instituições</h4>
								<?php if($ControladorUsuario->privilegio()>=1)
									echo "&nbsp;&nbsp;&nbsp;<a href=\"cadastrar_instituicao.php\"><span class=\"label label-warning\">Adicionar Instituição</span></a>";
								?>
								<div class="tools">
										...
										<?php
											...
											while($linha = $result->fetch_assoc()){
									            echo "
													...
													<!--	<a href=\"javascript:ver(".$linha['id_instituicao'].");\">
																<span class=\"label label-info\">
																	Visualizar
																</span>	
															</a>	&nbsp; -->
															<a href=\"javascript:editar(".$linha['id_instituicao'].");\">
																<span class=\"label label-success\">
																	...
																	if($ControladorUsuario->privilegio()==2)
																		echo"
																			...
																			<a href=\"javascript:excluir(".$linha['id_instituicao'].");\">
												...
												echo"
													...
													<td>".$linha['nome_instituicao']."</td>
													<td>".$linha['municipio']."</td>
													<td>".$linha['UF']."</td>
													<td>".$linha['jurisdicao']."</td>
	...
	<!-- BEGIN JAVASCRIPTS -->
		...
		<script type="text/javascript">
	        function excluir(id){
	        	if(window.confirm("Excluir uma instituição também apagará todos os registros de departamentos associados a ela.\n\nDeseja realmente excluir?")){

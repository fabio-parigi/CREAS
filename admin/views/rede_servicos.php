					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>6. Rede de serviços</h4> 
			                    <div class="tools">
							...
							<!-- Form Name -->
							<legend>Rede de serviços</legend>

							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Quais utiliza</label>  
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Atende à necessidade</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

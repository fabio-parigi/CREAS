<?php
     ...
     **********************************************/
		...
		if(isset ($_POST['nome'])) {
		    $count = $ControladorTipoPessoa->BuscarNomeTipoPessoa($Banco, $_POST['nome']);
			
			if($count->num_rows == 0){
		        $Novo = new TipoPessoaSchema(NULL,$_POST['nome']);

		        if($ControladorTipoPessoa->AdicionarTipoPessoa($Novo, $Banco)){
		        	
		        	$tipo = "sucesso";
		        	$msgn = "Tipo cadastrado com sucesso.";
		        	$confirma = TRUE;
		        ...
		        $tipo = "erro";
		        $msgn = "O nome do tipo escolhido já consta na base da dados. Tente novamente com um nome diferente.";
		        $confirma = TRUE;
		    }
		}
	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<?php $Paginas->setTitleBarra("Tipo de Pessoa","Tipos de Pessoa<span class=\"icon-angle-right\"></span>Cadastro"); ?>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>Cadastro de Tipo de Pessoa</h4> 
			                    <div class="tools">
			                        <a href="javascript:;" class="collapse"></a>
			                    </div>
			                </div>
		                    <div class="portlet-body form">
		                        <form name="formTipoPessoa" class="form-horizontal" action="cadastrar_tipo_pessoa.php" method="post"/>
			                        
			                        <div class="control-group">
			                           	<label class="control-label">Nome do Tipo</label>
			                           	<div class="controls">
			                               	<input class="span6 m-wrap" name="nome" type="text" pattern=".{0,50}" title="No máximo cinquenta caracteres." required/>
			                           	</div>
			                        </div>

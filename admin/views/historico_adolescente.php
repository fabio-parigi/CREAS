					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>8. Histórico do adolescente</h4> 
			                    <div class="tools">
							...
							<!-- Form Name -->
							<legend>Histórico do Adolescente</legend>

		

							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Nascimento e Infância</label>  
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Saúde física e Mental</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

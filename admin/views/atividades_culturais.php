					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>12. Atividades culturais, esportivas e de lazer</h4> 
			                    <div class="tools">
							...
							<!-- Form Name -->
							<legend>  Atividades culturais, esportivas e de lazer</legend>

		
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Frequenta atividades culturais? Quais?</label>  
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Frequenta atividades de lazer? Quais?</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Pratica esportes? Quais e com que frequência?</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

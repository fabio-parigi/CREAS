					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>13. Expectativas do adolescente e família ou responsável</h4> 
			                    <div class="tools">
							...
							<!-- Form Name -->
							<legend>Expectativas do adolescente e família ou responsável</legend>

							<!-- Textarea -->
							<div class="form-group">
							  <label class="col-md-4 control-label" for="textarea">Expectativas</label>

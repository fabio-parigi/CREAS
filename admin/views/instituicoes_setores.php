<?php
     ...
     **********************************************/
		if(isset($_REQUEST['idDelete'])) {
		    if($ControladorSetores->DeletarSetor($_REQUEST['idDelete'], $Banco)){
				$tipo = "sucesso";
		    	...
		    	$tipo = "erro";
		    	$msgn = "Ocorreu um erro ao deletar o Setor. Informe ao Administrador que ocorreu um \"Exception\" no Banco de Dados para que ele possa arrumar.";
		    	$confirma = TRUE;
		    }
	    }

	    $result = $ControladorSetores->ListarSetores($Banco,"");
	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<?php $Paginas->setTitleBarra("Setores","Instituições<span class=\"icon-angle-right\"></span>Setores"); ?>
					</div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<!-- DELETE FORM -->
							<form name="formDelete" type="hidden"  action="instituicoes_setores.php" method="post"/>
								<input type="hidden" name="idDelete" value="">
							</form>
						<!-- END DELETE FORM -->

						<!-- EDIT FORM -->
							<form name="formEdit" type="hidden"  action="editar_setor.php" method="post"/>
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-reorder"></i>Setores</h4>
								<?php if($ControladorUsuario->privilegio()>=1)
									echo "&nbsp;&nbsp;&nbsp;<a href=\"cadastrar_setor.php\"><span class=\"label label-warning\">Adicionar Setor</span></a>";
								?>
								<div class="tools">
									...
									<tbody>
										<?php
											...
											while($linha = $result->fetch_assoc()){
												...
												$nome = $ControladorInstituicoes->GetNomeInstituicao($Banco,$linha['id_instituicao']); // para encontrar o nome da Instituição a partir do ID dela salvo na tabela de setores
												$a = $nome->fetch_assoc(); // variável auxiliar, só para fazer o fetch_assoc
									            ...
									            echo "
													...
													<tr class=\"odd gradeX\">
														<td class=\"hidden-phone\" style=\"width: 120px;\">
															...
															<a href=\"javascript:editar(".$linha['id_setor'].");\">
																<span class=\"label label-success\">
																	...
																	if($ControladorUsuario->privilegio()==2)
																		echo"
																			...
																			<a href=\"javascript:excluir(".$linha['id_setor'].");\">

					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>1.Identificação</h4> 
			                    <div class="tools">
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Data de Nasc.</label>  
							  
							  <input id="textinput" name="textinput" placeholder="dd/mm/AAAA" class="form-control input-md" type="text">
							...
							<div class="form-group">
							  ...
							  <input id="idade" name="idade" placeholder="" class="form-control input-md" type="text">
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Natural de:</label>  
							...
							<div class="form-group">
							  ...
							  <input id="Sexo" name="Sexo" placeholder="M/F" class="form-control input-md" type="text">
							</div>
							...
							<!-- Search input-->
							<div class="form-group">
							  <label for="searchinput">Filiação: Pai</label>

							    <input id="searchinput" name="searchinput" placeholder="" class="form-control input-md" type="search">
							    <p class="help-block">Digite para pesquisar por nome</p>
							...
							<div class="form-group">
							  <label  for="mae">Filiação: Mãe</label>
							    ...
							    <input id="mae" name="mae" placeholder="" class="form-control input-md" type="search">
							    <p class="help-block">Digite para pesquisar por nome</p>
							...
							<div class="form-group">
							  ...
							  <input id="responsavel" name="responsavel" placeholder="" class="form-control input-md" type="text">
							...
							<div class="form-group">
							  ...
							  <input id="endereco" name="endereco" placeholder="" class="form-control input-md" type="text">
							...
							<div class="form-group">
							  ...
							  <input id="bairo" name="bairo" placeholder="" class="form-control input-md" type="text">
							...
							<div class="form-group">
							  <label for="cep">CEP</label>
							    ...
							    <input id="cep" name="cep" placeholder="" class="form-control input-md" type="search">
							...
							<!-- Text input-->
							<div class="form-group">
							  <label  for="referencia">Referência para localização da moradia:</label>  
							
							  <input id="referencia" name="referencia" placeholder="" class="form-control input-md" type="text">
							...
							<div class="form-group">
							  ...
							  <input id="telefone" name="telefone" placeholder="" class="form-control input-md" type="text">
							...
							<div class="form-group">
							  ...
							  <input id="falarcom" name="falarcom" placeholder="" class="form-control input-md" type="text">

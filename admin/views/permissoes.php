	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<?php $Paginas->setTitleBarra("Permissões de Usuários","Usuários<span class=\"icon-angle-right\"></span>Permissões"); ?>
					</div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<!-- EDIT FORM -->
							<form name="formEditUsuario" type="hidden"  action="editar_permissoes_usuario.php" method="get"/>
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-reorder"></i>Usuários</h4>
									<!-- Aqui ficaria o botão de Adicionar -->
								<div class="tools">

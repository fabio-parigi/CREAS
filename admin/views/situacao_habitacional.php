					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>4. Situação Habitacional</h4> 
			                    <div class="tools">
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Espaço Físico Residencial</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Saneamento Básico</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Observações</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

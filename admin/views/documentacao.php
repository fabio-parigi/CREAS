					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>2.Documentação</h4> 
			                    <div class="tools">
		                           ...
		                           <form name="formRodape" class="form-horizontal" action="avisos.php" method="post"/>
										...
										<form class="form-horizontal">
											...
											<div class="form-group">
											  <label for="cn">CN Nª</label> 
											  <input id="cn" name="cn" placeholder="" class="form-control input-md" type="text">
											</div>
											
											<!-- Text input-->
											<div class="form-group">
											  <label for="livro">Livro</label>  											 
											  <input id="livro" name="livro" placeholder="" class="form-control input-md" type="text">																							  
											</div>

											<!-- Text input-->
											<div class="form-group">
											  <label for="fls">FLS</label>  											  
											  <input id="fls" name="fls" placeholder="" class="form-control input-md" type="text">																							  
											</div>

											<!-- Text input-->
											<div class="form-group">
											  <label for="cartorio">Cartório</label>  											  
											  <input id="cartorio" name="cartorio" placeholder="" class="form-control input-md" type="text">																							  
											</div>
											...
											<div class="form-group">
											  ...
											  <input id="municipio" name="municipio" placeholder="" class="form-control input-md" type="text">																							  
											</div>
											...
											<div class="form-group">
											  ...
											  <input id="dataemissao" name="dataemissao" placeholder="" class="form-control input-md" type="text">																					
											</div>

											<!-- Text input-->
											<div class="form-group">
											  <label for="ctps">C.T.P.S.  Nº</label>  											 
											  <input id="ctps" name="ctps" placeholder="" class="form-control input-md" type="text">																						
											</div>
											...
											<!-- Text input-->
											<div class="form-group">
											  <label  for="tituloeleitor">T. Eleitor</label>  											  
											  <input id="tituloeleitor" name="tituloeleitor" placeholder="" class="form-control input-md" type="text">																						
											</div>

											<!-- Text input-->
											<div class="form-group">
											  <label  for="secao">Seção</label>  											 
											  <input id="secao" name="secao" placeholder="" class="form-control input-md" type="text">																							 
											</div>
											
											<!-- Text input-->
											<div class="form-group">
											  <label for="zona">Zona</label>  											  
											  <input id="zona" name="zona" placeholder="" class="form-control input-md" type="text">																							
											</div>

											<!-- Text input-->
											<div class="form-group">
											  <label  for="cam">C.A.M.</label>  											  
											  <input id="cam" name="cam" placeholder="" class="form-control input-md" type="text">																							  
											</div>

											<!-- Text input-->
											<div class="form-group">
											  <label  for="cdi">C.D.I.</label>  											  
											  <input id="cdi" name="cdi" placeholder="" class="form-control input-md" type="text">																							 
											</div>

											<!-- Text input-->
											<div class="form-group">
											  <label for="cr">C.R.</label>  											  
											  <input id="cr" name="cr" placeholder="" class="form-control input-md" type="text">																							 
											</div>

											<!-- Text input-->
											<div class="form-group">
											  <label for="providenciar">A providenciar</label>  											  
											  <input id="providenciar" name="providenciar" placeholder="" class="form-control input-md" type="text">																							 
											</div>

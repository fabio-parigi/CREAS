					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>9. Escolarização</h4> 
			                    <div class="tools">
			                        <a href="javascript:;" class="collapse"></a>
			                    </div>
			                </div>
		                    <div class="portlet-body form">
		                           <form name="formRodape" class="form-horizontal" action="#" method="post"/>
							...
							<!-- Form Name -->
							<legend>Escolarização</legend>

		

							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Ingressou na escola com que idade?</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
								
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Está estudando?</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
									
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Série</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
									
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Período</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Nome da escola atual ou da última escola</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
									
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Vivencia escolar</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
	
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Providencias técnicas</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
							...
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Visitas e contato com o Diretor ou Orientador</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>10. Profissionalização</h4> 
			                    <div class="tools">
							...
							<!-- Form Name -->
							<legend>Profissionalização</legend>

		

							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Participou de cursos</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>
								
							<!-- Text input-->
							<div class="form-group">
							  <label for="textinput">Propostas de encaminhamento</label>  
							  <input id="textinput" name="textinput" placeholder="" class="form-control input-md" type="text">
							</div>

	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<?php $Paginas->setTitleBarra("Setores","Instituições<span class=\"icon-angle-right\"></span>Setores<span class=\"icon-angle-right\"></span>Novo Setor"); ?>
					</div>
				</div>
					...
					<div class="span12">
						...
						<div class="portlet box grey">
			                ...
			                <div class="portlet-title">
			                    <h4><i class="icon-reorder"></i>Cadastrar Setor</h4> 
			                    <div class="tools">
												...
												<option value=""/>
													<?php
														...
														while($linha = $result->fetch_assoc()){
															echo "
																<option value=".$linha['id_instituicao']."/>".$linha['nome_instituicao']."</option>
																";
														}
													?>
